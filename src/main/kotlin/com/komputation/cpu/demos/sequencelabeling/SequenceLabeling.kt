...
fun main(args: Array<String>) {
    ...
    Network(
            ...
            recurrentLayer(numberSteps, true, embeddingDimension, 3, Direction.Forward, ResultExtraction.AllSteps, ActivationFunction.ReLU, initialization, initialization, null, optimization),
