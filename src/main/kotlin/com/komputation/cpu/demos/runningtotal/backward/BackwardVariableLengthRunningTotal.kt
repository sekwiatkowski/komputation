...
fun main(args: Array<String>) {
    ...
    Network(
            ...
            recurrentLayer(maximumLength, hasFixedLength, 1, 1, Direction.Backward, ResultExtraction.AllSteps, ActivationFunction.Identity, initialization, initialization, null, optimization)
        )
        .training(
            input,
            targets,
