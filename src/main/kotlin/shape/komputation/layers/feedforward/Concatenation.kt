...
class Concatenation(name : String? = null, vararg continuations: Array<ContinuationLayer>) : ContinuationLayer(name), Optimizable {
...
fun createConcatenation(vararg continuations: Array<ContinuationLayer>) =

    createConcatenation(null, *continuations)

fun createConcatenation(vararg continuations: ContinuationLayer) =

    createConcatenation(null, *continuations)

fun createConcatenation(name : String?, vararg continuations: ContinuationLayer) =

    Concatenation(name, *continuations.map { layer -> arrayOf<ContinuationLayer>(layer) }.toTypedArray())

fun createConcatenation(name : String?, vararg continuations: Array<ContinuationLayer>) =
