package shape.komputation.cpu.forward.decoder
...
import shape.komputation.cpu.forward.activation.CpuSoftmaxVectorLayer
...
class CpuAttentiveDecoder internal constructor(
    ...
    private val activationFunctions: Array<CpuActivationLayer>,
